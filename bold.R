...
taxones <- c("Pilumnus", "Microphrys", "Acanthonyx petiverii", 
             "Conopea", "Balanus", "Stenothoe", "Synalpheus")
...
#ESCOGER LAS COLUMNAS DE MI INTERES
datos_coi5p <- datos %>%
...
sum(!is.na(datos_coi5p$genbank_id))
...
write.csv(datos_coi5p, "datos_coi5p.csv", row.names = FALSE)
